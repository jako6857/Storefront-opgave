        ...
        modalBody.innerHTML = `
            ...
            <div class="modal-details">
                ...
                <div class="modal-meta">
                    <div class="meta-item"><span class="meta-label">Brand</span><span class="meta-value">${product.brand || 'N/A'}</span></div>
                    <div class="meta-item"><span class="meta-label">Category</span><span class="meta-value">${product.category}</span></div>
                    <div class="meta-item"><span class="meta-label">Stock</span><span class="meta-value">${product.stock} units</span></div>
                    <div class="meta-item"><span class="meta-label">Discount</span><span class="meta-value">${product.discountPercentage}%</span></div>
                </div>
...
function renderMainCategories() {
    ...
    for (const mainCat of Object.keys(categoryMapping)) {
        html += `<button class="main-category-btn" data-category="${mainCat}">${mainCat}</button>`;
    }
...
function renderSubcategories(mainCat) {
    ...
    subCats.forEach(subCat => {
        html += `<button class="subcategory-btn" data-category="${subCat}">${categoryDisplayNames[subCat]}</button>`;
    });
